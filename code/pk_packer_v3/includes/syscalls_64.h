...
{ \
long __res; \
__asm__ volatile ("push %%rbp ; mov %%rax,%%rbp ; mov %1,%%rax ; int $0x80 ; pop %%rbp" \
        : "=a" (__res) \
...
static inline __syscall6(void *, mmap, void *, addr, size_t, len, int, prot, int, flags, int, fd, off_t, offset);
